# kobo-update-3.3.1 (38384a81c1, 2014/05/14) #
## Mark4 ##
  * dosfsckを4回実行しても0以外が戻ってくるようなら，ファクトリーリセット画面が出るように変わった．
  * /usr/local/Kobo 以下のファイルのuid，gidがbuild(= 3018)になっていやがる．また雑な仕事を....
...
|`/usr/local/Kobo/unrar`|－|◯|－|5.10 beta 1|
|`/usr/local/Kobo/zim`|－|◯|－|  |
